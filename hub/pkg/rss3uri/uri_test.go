...
func TestParse(t *testing.T) {
	...
	uri, err = rss3uri.Parse("https://github.com/NaturalSelectionLabs/RSS3-PreGod")
	assert.ErrorIs(t, err, rss3uri.ErrInvalidScheme)

	uri, err = rss3uri.Parse("rss3://foobar:0xC8b960D09C0078c18Dcbe7eB9AB9d816BcCa8944@evm")
	assert.ErrorIs(t, err, rss3uri.ErrInvalidPrefix)

	uri, err = rss3uri.Parse("rss3://account:@evm")
	assert.ErrorIs(t, err, rss3uri.ErrInvalidIdentity)

	uri, err = rss3uri.Parse("rss3://account:NaturalSelectionLabs@github")
